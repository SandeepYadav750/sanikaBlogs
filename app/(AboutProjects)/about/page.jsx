  ...
  return (
    <section className=" py-16 px-6">
      <div className="max-w-5xl mx-auto">
        ...
        {/* Main Content Card */}
        <div className="bg-white dark:bg-gray-700 rounded-2xl p-8 md:p-10 shadow-2xl border border-gray-700 space-y-6 md:space-y-10">
          ...
          {/* Quote */}
          <div className="bg-gray-300 dark:bg-gray-900 border-l-4 border-red-500 pl-6 py-2 bg-opacity-50 rounded-r-lg text-center">
